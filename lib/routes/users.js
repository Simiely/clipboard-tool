...
export const userRoutes = [
  ...
  { p: "/api/users", m: "POST", handler: async (req, res) => {
    ...
    const user = users.createUser(body.name, body.password || "");
    // 新建即签发 token（零摩擦进入）
